...
export class Socket1750890230145 implements MigrationInterface {
  name = 'Socket1750890230145';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "message" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "senderId" character varying NOT NULL, "content" text NOT NULL, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "chatId" uuid, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "user1" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "user2" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "timestamp" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "chat" ADD "message" text NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "receiverId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "senderId" character varying NOT NULL`,
    );
